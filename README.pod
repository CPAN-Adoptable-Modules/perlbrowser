...
=head1 The App::perlbrowser module

This is the I<README> for the L<App::perlbrowser> Perl module. You're probably 
...
To read about L<App::perlbrowser>, look at the embedded documentation 
in the module itself. Inside the distribution, you can format it 
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/App/perlbrowser.pm

If you have already installed the module, you can specify the module
name instead of the file location:

	% perldoc App::perlbrowser

You can read the documentation and inspect the meta data on one of the 
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/App-perlbrowser> or 
L<MetaCPAN|http://www.metacpan.org/module/App::perlbrowser>:

=over 4

=item *	L<http://search.cpan.org/dist/App-perlbrowser>

=item *	L<http://www.metacpan.org/module/App::perlbrowser>
...
and install the dependencies:
	...
	% cpan App::perlbrowser
	% cpanm App::perlbrowser
...
=item *	L<https://github.com/briandfoy/perlbrowser>

=back

If you find a problem, file a ticket in the L<issue 
tracker|https://github.com/briandfoy/perlbrowser/issues>:

=over 4

=item *	L<https://github.com/briandfoy/perlbrowser/issues>
